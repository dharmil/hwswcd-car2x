...
$(MEM_1)_START := 0x08002000
$(MEM_1)_END := 0x08002fff
...
.PHONY: shared_memory
shared_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
