//1583 - 1585 were commented due to LR fpga non functioning status also frei and delete
//1568 condition modified to consider 3
//1597 kommentierten send for LR wheel //1269 1520 1597 1617 remove the velocity
...
//										}
		...
		//if(state.currMode==OPMODE_PREOPERATIONAL && state.reqMode!=OPMODE_IDLE && wheel_LF!=NULL){
			...
			LOG_DEBUG("****************************** WELCOME AT MILESTONE NO. 1 *************************************************");
			...
			LOG_DEBUG("***************************  Herzlich Wilkommen bei Meilenstein No. 2 *****************************************");
