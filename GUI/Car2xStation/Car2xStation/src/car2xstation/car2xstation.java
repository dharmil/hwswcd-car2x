...
public class car2xstation extends javax.swing.JFrame {
    ...
    public static String hostIP = "192.168.0.200";
    public static String myIP0x = "c0a80096";                   //dot forget this one if changing the IP!!!
                ...
                case CONNECTED:
                    try {
                        ...
                        if (remoteMode && tries % 10 == 0) {
                            ...
                            left=Integer.toHexString(leftSide);
                            right=Integer.toHexString(rightSide);
                            while (left.length() < 4) {
                                left = "0" + left;
                            }
                            ...
                            station.messageText += left + left + right + right;
                            //header
                            ubyte[] header = new ubyte[6];
                            header[0] = new ubyte('C');
                            header[1] = new ubyte('A');
